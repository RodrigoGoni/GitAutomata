function OptimalPath=ASTARPATH(StartX,StartY,x_obj,y_obj)
%Version 1.0
% By Einar Ueland 2nd of May, 2016
MAP=int8(zeros(80,45));

%FINDING ASTAR PATH IN AN OCCUPANCY GRID
GoalRegister=int8(zeros(80,45));
GoalRegister(x_obj,y_obj)=1;
